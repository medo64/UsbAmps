...
#define OPTION_TYPE_AVG   0
#define OPTION_TYPE_MAX   1
#define OPTION_TYPE_MIN   2
...
#define OPTION_UNITTYPE_CAPACITY_1    9
#define OPTION_UNITTYPE_CAPACITY_2   10
#define OPTION_UNITTYPE_CAPACITY_3   11
